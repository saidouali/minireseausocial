drop database if exists minisocial;
...
INSERT INTO sujet (`id`, `id_groupe`, `titre`, `contenu`, `date_creation`, `id_user`) VALUES
(1, 1, 'IA', 'Contenus', '2022-05-07 00:00:00', 1),
(2, 1, 'Manager Info', 'Contenus', '2022-05-08 00:00:00', 1),
(3, 1, 'Big Data', 'Contenus', '2022-05-09 00:00:00', 1),
(4, 1, 'Robotique', 'Contenus', '2022-05-10 00:00:00', 1);
...
CREATE TABLE blog (
  ...
  text text NOT NULL,
  date_creation datetime NOT NULL,
  categorie int(250) NOT NULL,
  PRIMARY KEY (`id`)
);


INSERT INTO blog (`id`, `id_user`, `titre`, `text`, `date_creation`, `categorie`) VALUES
(1, 12, 'IA', 'définition', '2022-05-10 16:51:00', 1),
(2, 12, 'Manager Informatique', 'contenus de mon groupe', '2022-05-10 16:59:00', 1);



CREATE TABLE commentaire (
  id int(255) NOT NULL AUTO_INCREMENT,
  id_sujet int(255) NOT NULL,
  id_user int(255) NOT NULL,
  text text NOT NULL,
